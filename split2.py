...
def split_pdf(input_path):
    ...
    try:
        ...
        # Collect odd pages into a list (to later reverse) and process even pages immediately.
        odd_pages = []
        ...
        print(f"    ↳ Odd pages (reversed):  {odd_output_path}")
